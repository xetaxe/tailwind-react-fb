const Header = () => {
	return(
		<div className="flex items-center bg-fb-white w-full shadow overflow-hidden pr-4 ">
			<div className="w-full mr-4">

				<div className="flex items-center">

					<div className="py-4 px-[1.25rem] grow-0 shrink-0">
					...
					<div className="grow pr-2">
						...
						<div className="bg-[#F0F2F5] rounded-full flex items-center sm:max-w-[456px] md:m-auto w-fit">
							<div className="p-3">
							...
							<div className="p-y-2 grow w-[calc(100vw-205px)] sm:w-full">
								<input type="text" className="p-0 bg-transparent font-normal sm:w-[276px] md:w-[476px] text-[15px] placeholder-fb-gray placeholder:opacity-100 text-fb-black outline-none" name="Facebook search" placeholder="Search Facebook" id="fb_search" />
							</div>
			...
			<div className="bg-fb-lightgray mr-2 rounded-full p-2.5 flex-grow-0 relative">
			...
			<div className="bg-fb-lightgray mr-2 rounded-full p-2.5 flex-grow-0 shrink-0 relative">
				<span className="absolute bg-fb-red rounded-full text-center w-[18px] aspect-square text-xs font-semibold bottom-2/3 left-2/3 text-fb-white">1</span>
			...
			<div className="flex justify-center relative flex-grow-0 shrink-0">
				<img src="/src/assets/img-small/person.jpg" alt="Person's profile" className="rounded-full w-10 aspect-square"/>
					<div className="absolute bg-fb-lightgray rounded-full top-2/3 left-2/3 border-2 border-fb-white">
					<svg fill="currentColor" viewBox="0 0 16 16" className="w-3 aspect-square">
